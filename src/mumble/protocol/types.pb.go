...
func (this *MumbleServer) Reset()         { *this = MumbleServer{} }
func (this *MumbleServer) String() string { return proto.CompactTextString(this) }
func (*MumbleServer) ProtoMessage()       {}

func (this *MumbleServer) GetBanList() *BanList {
	if this != nil {
		return this.BanList
	}
	return nil
