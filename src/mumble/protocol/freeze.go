...
//)
//
//// TODO: GET RID OF ALL OF THIS, its a bad embedded go db
//
...
//func (server *Server) Freeze() (freezeServer *Server, err error) {
//	freezeServer = new(Server)
...
//
//	// TODO: Is this really freezing it? Or just wasting resource?
//	// Freeze all bans
...
//
//	// TODO: MAKE FREEZING PUTTING SHIT IN A KEY/VALUE bucket, stop reinvineting wheels poorly
//	// Freeze all channels
//	//channels := []*Channel{}
//	//for _, channel := range server.Channels {
//	//	freezeChannel, err := channel.Freeze()
//	//	if err != nil {
//	//		return nil, err
//	//	}
//	//	channels = append(channels, freezeChannel)
//	//}
//	//freezeServer.channels = channels
//
//	//// Freeze all registered users
//	//users := []*User{}
//	//for _, user := range server.Users {
//	//	freezeUser, err := user.Freeze()
//	//	if err != nil {
//	//		return nil, err
//	//	}
//	//	users = append(users, freezeUser)
//	//}
//	//freezeServer.Users = users
//	// TODO:Seeems totally fucking useless and I hate the term freeze, why not just WriteConfig?
//	return freezeServer, nil
//}
//
